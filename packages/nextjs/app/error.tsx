"use client"; // Must be a client componenta
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.errorContainer}>
        <p>
          While we sweep up the digital debris, here are some possible causes:
        </p>
      ...
      <p
        className={classes.errorSuggestion}
      >{`But don't panic (yet). Try one of these:`}</p>

      <div className={classes.errorActions}>
        <p className="text-lg lg:text-2xl font-medium m-0 space-x-4">
          <a href="/" className={classes.actionLink}>
            Try Again
          </a>{" "}
          |
          <a href="/" className={classes.actionLink}>
