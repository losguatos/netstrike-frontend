const styles = {
  container:
    "flex flex-col items-center justify-center min-h-screen bg-black text-center font-mono px-4",
  ...
  ctaContainer:
    "flex items-center justify-center bg-green-600 rounded px-4 py-4", //Fondo verde con hover negro
