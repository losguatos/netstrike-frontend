...
export const classes = {
  ...
  errorMessage: clsx(
    "text-base md:text-lg max-w-[90%] md:max-w-[1041px]"
  ),
  errorContainer: clsx(
    "w-full max-w-[1041px] text-lg md:text-xl font-medium"
  ),
  errorList: clsx(
    "list-disc list-inside space-y-4 md:space-y-8"
  ),
  errorSuggestion: clsx(
    "text-lg md:text-xl"
  ),
  errorActions: clsx(
